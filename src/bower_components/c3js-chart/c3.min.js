...
!(function(t, e) {
  ...
  ((s = p.prototype).axisX = function(t, e, i) {
    ...
    (s.tspanData = function(t, e, i) {
      ...
      return (
        n.params.tickMultiline && 0 < n.params.tickMultilineMax && (a = n.ellipsify(a, n.params.tickMultilineMax)),
        a.map(function(t) {
    ...
    (s.splitTickText = function(t, e) {
      ...
      return (
        (!c || c <= 0) && (c = o.isVertical() ? 95 : o.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110),
        (function t(e, i) {
          r = void 0;
          for (var n = 1; n < i.length; n++)
            if (
              (' ' === i.charAt(n) && (r = n), (a = i.substr(0, n + 1)), (s = o.tickTextCharSize.w * a.length), c < s)
            )
            ...
            switch (w.orient) {
              ...
              case 'left':
                (t = w.axisY),
                  ...
                  f.attr('x', -w.tickLength).attr('dy', function(t, e) {
                    return w.tspanDy(t, e);
                  }),
  ...
  return (
    ...
    (r.getXAxis = function(t, e, i, n, a, r, s) {
      ...
      return (
        ...
        o.isCategorized() &&
          (u.tickCentered(c.axis_x_tick_centered), g(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
        u
      );
    }),
          ...
          (s.svg &&
            ...
            'y' === t
              ? ((n = s.y.copy().domain(s.getYDomain(i, 'y'))),
                (a = this.getYAxis(n, s.yOrient, o.axis_y_tick_format, s.yAxisTickValues, !1, !0, !0)))
              : 'y2' === t
                ? ((n = s.y2.copy().domain(s.getYDomain(i, 'y2'))),
                  (a = this.getYAxis(n, s.y2Orient, o.axis_y2_tick_format, s.y2AxisTickValues, !1, !0, !0)))
    ...
    (m.initWithData = function(t) {
      ...
      (n.axis = new S(n)),
        ...
        n.initEventRect(),
        r.axis_x_selection && n.brush.selectionAsValue(n.getDefaultSelection()),
        s &&
          (n.updateDimension(),
    ...
    (m.redraw = function(t, e) {
      ...
      if (
        ...
        l && D.legend_show ? I.updateLegend(I.mapToIds(I.data.targets), t, e) : g && I.updateDimension(!0),
        I.isCategorized() && 0 === H.length && I.x.domain([0, I.axes.x.selectAll('.tick').size()]),
        H.length
          ? (I.updateXDomain(H, c, d, u), D.axis_x_tick_values || (C = I.axis.updateXAxisTickValues(H)))
    ...
    (m.transformMain = function(t, e) {
      var i,
        ...
        a,
        r = this;
      e && e.axisX ? (i = e.axisX) : ((i = r.main.select('.' + Y.axisX)), t && (i = i.transition())),
        e && e.axisY ? (n = e.axisY) : ((n = r.main.select('.' + Y.axisY)), t && (n = n.transition())),
        e && e.axisY2 ? (a = e.axisY2) : ((a = r.main.select('.' + Y.axisY2)), t && (a = a.transition())),
        ...
        r.main.select('.' + Y.chartArcs).attr('transform', r.getTranslate('arc'));
    }),
    ...
    'SVGPathSegList' in window ||
      ...
      (window.SVGPathSegList.prototype.initialize = function(t) {
        return (
          this._checkPathSynchronizedToList(), (this._list = [t]), (t._owningPathSegList = this)._writeListToPath(), t
        );
      }),
          ...
          (i.prototype._parseNumber = function() {
            ...
            if (
              ...
              if (this._currentIndex != o)
                for (var c = this._currentIndex - 1, d = 1; o <= c; )
              ...
              var u = e + n;
              if (((u *= a), t && (u *= Math.pow(10, r * t)), s != this._currentIndex))
      ...
      (a = c.convertDataToTargets(e, !0)),
        ...
        c.data.targets.forEach(function(t) {
          ...
          for (e = 0; e < d.length; e++)
            if (t.id === d[e])
              for (h = t.values[t.values.length - 1].index + 1, i = 0; i < l; i++)
                t.values.push({
                  id: t.id,
                  index: h + i,
            ...
            : 1 !== O.data.targets[0].values.length
              ...
              : O.isTimeSeries()
                ? ((A = O.getValueOnIndex(O.data.targets[0].values, 0)),
                  (T = O.getValueOnIndex(O.data.targets[0].values, O.data.targets[0].values.length - 1)),
                  (t = O.x(A.x) - O.x(T.x)))
                : (t = D(i) / 2),
          ...
          V(function() {
            ...
            n
              ...
              s
                ...
                .attr('x', m)
                .attr('y', S)
                .style('fill-opacity', O.opacityForText.bind(O)),
        ...
        l.main
          ...
          .each(function(t, e) {
            ...
            i.classed(Y.line) ||
              i.classed(Y.area) ||
              (r && s
                ? g.data_selection_isselectable(t) && !o && a(!0, i.classed(Y.SELECTED, !0), t, e)
                : k(u) && u && o && a(!1, i.classed(Y.SELECTED, !1), t, e));
          });
    }),
      ...
      h.data_selection_enabled &&
        u.main
          ...
          .each(function(t, e) {
            ...
            i.classed(Y.line) ||
              i.classed(Y.area) ||
              (r && s && h.data_selection_isselectable(t) && o && a(!1, i.classed(Y.SELECTED, !1), t, e));
          });
    }),
    (x.show = function(t, e) {
      var i,
      ...
      return t
        ? (e.isTimeSeries() &&
          ...
          e.config.subchart_show
            ...
            : (e.updateXDomain(null, !0, !1, !1, t), e.redraw({ withY: e.config.zoom_rescale, withSubchart: !1 })),
    ...
    (m.expandArc = function(t) {
      ...
      i.transiting
        ? (e = window.setInterval(function() {
            i.transiting ||
              (window.clearInterval(e), 0 < i.legend.selectAll('.c3-legend-item-focused').size() && i.expandArc(t));
          }, 10))
    ...
    (m.getArcLabelFormat = function() {
      ...
      return (
        this.hasType('gauge') ? (e = t.gauge_label_format) : this.hasType('donut') && (e = t.donut_label_format), e
      );
    }),
      ...
      if (
        ...
        d
          ...
          .style('font-size', function(t) {
            return u.isGaugeType(t.data) && 1 === u.filterTargetsToShow(u.data.targets).length
        ...
        d.select('.' + Y.chartArcsTitle).style('opacity', u.hasType('donut') || h ? 1 : 0),
        h)
      ) {
        var g = 0;
        (r = u.arcs
          ...
          u.arcs
            ...
            .attr('dx', -1 * (u.innerRadius + (u.radius - u.innerRadius) / (c.gauge_fullCircle ? 1 : 2)) + 'px')
            .attr('dy', '1.2em')
            .text(c.gauge_label_show ? u.textForGaugeMinMax(c.gauge_min, !1) : ''),
          u.arcs
            .select('.' + Y.chartArcsGaugeMax)
            .attr('dx', u.innerRadius + (u.radius - u.innerRadius) / (c.gauge_fullCircle ? 1 : 2) + 'px')
            .attr('dy', '1.2em')
            .text(c.gauge_label_show ? u.textForGaugeMinMax(c.gauge_max, !0) : '');
      }
    }),
      ...
      return function(t) {
        ...
        return (
          n[i] instanceof Function
            ...
            : n[i]
              ? (e = n[i])
              : (s.indexOf(i) < 0 && s.push(i), (e = a[s.indexOf(i) % a.length]), (n[i] = e)),
    ...
    (m.loadConfig = function(e) {
      ...
      Object.keys(r).forEach(function(t) {
        (i = e),
          ...
          (a = (function t() {
            var e = n.shift();
            return e && i && 'object' === (void 0 === i ? 'undefined' : o(i)) && e in i
              ? ((i = i[e]), t())
              : e
                ? void 0
                : i;
    ...
    (m.convertUrlToData = function(t, e, i, n, a) {
      ...
      'json' === c
        ...
        : ((r = 'tsv' === c ? o.d3.tsv : o.d3.csv), (s = o.convertXsvToData)),
        r(t, i)
          .then(function(t) {
            ...
            rows: [
              e.reduce(function(t, e) {
                return Object.assign(
                  ...
                  ((a = null),
                  (n = e) in (i = {})
                    ? Object.defineProperty(i, n, { value: a, enumerable: !0, configurable: !0, writable: !0 })
                    : (i[n] = a),
                  i)
                );
                var i, n, a;
    ...
    (m.hasDataLabel = function() {
      var t = this.config;
      return (
        !('boolean' != typeof t.data_labels || !t.data_labels) || !('object' !== o(t.data_labels) || !C(t.data_labels))
      );
    }),
      ...
      return (
        ...
        0 === _.length
          ...
          : (isNaN(m) && (m = 0),
            ...
            void 0 !== w && ((S = w + (o = Math.max(Math.abs(m), Math.abs(S)))), (m = w - o)),
            A
            ...
            'y' === e &&
              C(f.axis_y_padding) &&
              ((r = g.axis.getPadding(f.axis_y_padding, 'top', r, a)),
              (s = g.axis.getPadding(f.axis_y_padding, 'bottom', s, a))),
            'y2' === e &&
              C(f.axis_y2_padding) &&
              ((r = g.axis.getPadding(f.axis_y2_padding, 'top', r, a)),
              (s = g.axis.getPadding(f.axis_y2_padding, 'bottom', s, a))),
            v && (l && (s = m), h && (r = -S)),
            (n = [m - s, S + r]),
            b ? n.reverse() : n)
      );
    ...
    (m.getXDomainPadding = function(t) {
      ...
      return (
        ...
        'object' === o(r.axis_x_padding) && C(r.axis_x_padding)
          ? ((n = P(r.axis_x_padding.left) ? r.axis_x_padding.left : i),
            (a = P(r.axis_x_padding.right) ? r.axis_x_padding.right : i))
    ...
    (m.updateXDomain = function(t, e, i, n, a) {
      ...
      return (
        ...
        e && r.x.domain(a || (!r.brush || r.brush.empty() ? r.orgXDomain : r.brush.selectionAsValue())),
    ...
    (m.updateGrid = function(t) {
      ...
      r.grid.style('visibility', r.hasArcType() ? 'hidden' : 'visible'),
        ...
        r.ygridLines
          ...
          .transition()
          .duration(t)
          .attr('x', o.axis_rotated ? r.xGridTextX.bind(r) : r.yGridTextX.bind(r))
          .attr('y', d)
          .text(function(t) {
            return t.text;
          })
    ...
    (m.generateGridData = function(t, e) {
      var i,
        ...
        o = this.main
          ...
          .size();
      if ('year' === t)
        for (n = (i = this.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), r = n; r <= a; r++)
    ...
    (m.redrawEventRect = function() {
      ...
      (t = a.width),
        ...
        a.main
          .select('.' + Y.eventRects)
          .style('cursor', s.zoom_enabled ? (s.axis_rotated ? 'ns-resize' : 'ew-resize') : null),
        a.eventRect
          .attr('x', 0)
          .attr('y', 0)
          .attr('width', t)
          ...
          .on(
            ...
            s.interaction_enabled
              ? function() {
                  ...
                  a.dragging ||
                    a.hasArcType(t) ||
                    ((t = a.filterTargetsToShow(a.data.targets)),
                    (e = r.mouse(this)),
                    (i = a.findClosestFromTargets(t, e)),
                    !a.mouseover ||
                      (i && i.id === a.mouseover.id) ||
                      (s.data_onmouseout.call(a.api, a.mouseover), (a.mouseover = void 0)),
                    i
                      ? ((n = (a.isScatterType(i) || !s.tooltip_grouped ? [i] : a.filterByX(t, i.x)).map(function(t) {
                          return a.addName(t);
                        })),
                        ...
                        a.showXGridFocus(n),
                        (a.isBarType(i.id) || a.dist(i, e) < s.point_sensitivity) &&
                          (a.svg.select('.' + Y.eventRect).style('cursor', 'pointer'),
                          a.mouseover || (s.data_onmouseover.call(a.api, i), (a.mouseover = i))))
                      : o());
                }
              : null
          )
            ...
            s.interaction_enabled
              ? function() {
                  ...
                  a.hasArcType(t) ||
                    ...
                    (i = a.findClosestFromTargets(t, e)) &&
                      (a.isBarType(i.id) || a.dist(i, e) < s.point_sensitivity) &&
                      (a.isScatterType(i) || !s.data_selection_grouped ? [i] : a.filterByX(t, i.x)).forEach(function(
                        t
                      ) {
                        a.main
                          .selectAll('.' + Y.shapes + a.getTargetSelectorSuffix(t.id))
                          .selectAll('.' + Y.shape + '-' + t.index)
                          .each(function() {
                            (s.data_selection_grouped || a.isWithinShape(this, t)) &&
                              (a.toggleShape(this, t, t.index), s.data_onclick.call(a.api, t, this));
                          });
                      }));
                }
              : null
          ...
          .call(
            s.interaction_enabled && s.data_selection_draggable && a.drag
              ? r
                  .drag()
                  .on('drag', function() {
                    a.drag(r.mouse(this));
    ...
    (m.hideLegend = function(t) {
      var e = this,
        i = e.config;
      i.legend_show && g(t) && ((i.legend_show = !1), e.legend.style('visibility', 'hidden')),
    ...
    (m.updateLegend = function(p, t, e) {
      ...
      function R(t, e, i) {
        var n,
          ...
          d = ((r = t),
          (s = e),
          m.legendItemTextBox[s] || (m.legendItemTextBox[s] = m.getTextRect(r.textContent, Y.legendItem, r)),
      ...
      (p = p.filter(function(t) {
        ...
        m.isLegendInset && ((I = S.legend_inset_step ? S.legend_inset_step : p.length), m.updateLegendStep(I)),
        m.isLegendRight
          ? ((i = function(t) {
              return b * O[t];
            }),
    ...
    (m.toggleShape = function(t, e, i) {
      ...
      r.data_selection_enabled &&
        ...
        (r.data_selection_multiple ||
          n.main
            .selectAll('.' + Y.shapes + (r.data_selection_grouped ? n.getTargetSelectorSuffix(e.id) : ''))
            .selectAll('.' + Y.shape)
            .each(function(t, e) {
              var i = a.select(this);
    ...
    (m.generateGetBarPoints = function(t, e) {
      ...
      return function(t, e) {
        ...
        return (
          ...
          [[a + l, n], [a + l, r - (i - n)], [a + o - l, r - (i - n)], [a + o - l, n]]
        );
      };
    }),
      ...
      return (
        n.isTargetToShow(e.id)
          ? 'circle' === t.nodeName
            ...
            : 'path' === t.nodeName && (i = !a.classed(Y.bar) || n.isWithinBar(n.d3.mouse(t), t))
          : (i = !1),
        i
      );
    }),
          ...
          return (
            c.isLineType(t)
              ? d.data_regions[t.id]
                ...
                : (c.isStepType(t) && (i = c.convertValuesToStep(i)), (e = u.curve(c.getInterpolate(t))(i)))
              : (i[0] && ((r = n(i[0].x)), (s = a(i[0].value))),
                (e = d.axis_rotated ? 'M ' + s + ' ' + r : 'M ' + r + ' ' + s)),
            e || 'M 0 0'
          );
        }
      );
    ...
    (m.generateGetLinePoints = function(t, e) {
      ...
      return function(t, e) {
        ...
        return (
          ...
          [[a, r - (i - n)], [a, r - (i - n)], [a, r - (i - n)], [a, r - (i - n)]]
        );
      };
    }),
    (m.lineWithRegions = function(t, c, d, e) {
      ...
      if (k(e))
        for (i = 0; i < e.length; i++)
          (m[i] = {}),
            v(e[i].start)
              ? (m[i].start = t[0].x)
              : (m[i].start = p.isTimeSeries() ? p.parseDate(e[i].start) : e[i].start),
            v(e[i].end)
              ? (m[i].end = t[t.length - 1].x)
              : (m[i].end = p.isTimeSeries() ? p.parseDate(e[i].end) : e[i].end);
      function w(t) {
      ...
      for (
          ...
          a = p.isTimeSeries()
            ? function(t, e, i, n) {
                var a = t.x.getTime(),
                  ...
                  o = new Date(a + r * (i + n));
                return w(
                  _.axis_rotated ? [[d(u(i)), c(s)], [d(u(i + n)), c(o)]] : [[c(s), d(u(i))], [c(o), d(u(i + n))]]
                );
              }
            : function(t, e, i, n) {
                return w(
                  _.axis_rotated
                    ? [[d(u(i), !0), c(r(i))], [d(u(i + n), !0), c(r(i + n))]]
                    : [[c(r(i), !0), d(u(i))], [c(r(i + n), !0), d(u(i + n))]]
                );
              },
          i = 0;
        i < t.length;
        ...
        if (v(m) || !S(t[i].x, m)) x += ' ' + g(t[i]) + ' ' + f(t[i]);
          ...
          for (
            r = p.getScale(t[i - 1].x + y, t[i].x + y, p.isTimeSeries()),
              u = p.getScale(t[i - 1].value, t[i].value),
              s = c(t[i].x) - c(t[i - 1].x),
              o = d(t[i].value) - d(t[i - 1].value),
              h = 2 * (l = 2 / Math.sqrt(Math.pow(s, 2) + Math.pow(o, 2))),
              n = l;
            n <= 1;
            n += h
          )
    ...
    (m.generateDrawArea = function(t, e) {
      ...
      return (
        ...
        function(t) {
          ...
          return (
            r.isAreaType(t)
              ? (r.isStepType(t) && (i = r.convertValuesToStep(i)), (e = o.curve(r.getInterpolate(t))(i)))
              : (i[0] && ((n = r.x(i[0].x)), (a = r.getYScale(t.id)(i[0].value))),
                (e = s.axis_rotated ? 'M ' + a + ' ' + n : 'M ' + n + ' ' + a)),
            e || 'M 0 0'
          );
        }
      );
          ...
          : 'y' !== t || i.axis_y_show
            ? 'y2' !== t || i.axis_y2_show
              ? ('x' === t &&
                  ...
                  (n =
                    30 + e.axis.getMaxTickWidth(t) * Math.cos((Math.PI * (90 - Math.abs(i.axis_x_tick_rotate))) / 180)),
                'y' === t &&
                  i.axis_rotated &&
                  i.axis_y_tick_rotate &&
                  (n =
                    30 + e.axis.getMaxTickWidth(t) * Math.cos((Math.PI * (90 - Math.abs(i.axis_y_tick_rotate))) / 180)),
      ...
      return (
        ...
        (a.brush.updateExtent = function() {
          var t,
            e = this.scale.range();
          return (
            (t = a.config.axis_rotated ? [[0, e[0]], [a.width2, e[1]]] : [[e[0], 0], [e[1], a.height2]]),
            this.extent(t),
            this
          );
        }),
        ...
        (a.brush.selectionAsValue = function(t, e) {
          ...
          return t
            ? (a.context &&
                ...
                a.brush.move(n, i)),
              [])
            : ((i = a.brush.selection() || [0, 0]), [this.scale.invert(i[0]), this.scale.invert(i[1])]);
        }),
    ...
    (m.updateTargetsForSubchart = function(t) {
      ...
      o.subchart_show &&
        ...
        s
          ...
          .attr(o.axis_rotated ? 'width' : 'height', o.axis_rotated ? r.width2 : r.height2));
    }),
    ...
    (m.redrawSubchart = function(t, e, i, n, a, r, s) {
      ...
      u.context.style('visibility', h.subchart_show ? 'visible' : 'hidden'),
        h.subchart_show &&
          (l.event && 'zoom' === l.event.type && u.brush.selectionAsValue(u.x.orgDomain()),
          t &&
      ...
      for (p && t.sort(p), r = 0; r < t.length; r++)
        if (
          ...
          (c = _(g(t[r].name, t[r].ratio, t[r].id, t[r].index))),
            ...
            (a += "<tr class='" + u.CLASS.tooltipName + '-' + u.getTargetSelectorSuffix(t[r].id) + "'>"),
          ...
          : ((a = d.getSvgLeft(!0)),
            u.axis_rotated
              ? ((s = (r = a + g[0] + 100) + e),
                ...
                (o = d.x(t[0].x) + 20))
              : ((s = (r = a + d.getCurrentPaddingLeft(!0) + d.x(t[0].x) + 20) + e),
    ...
    (m.showTooltip = function(t, e) {
      ...
      0 !== c.length &&
        s.tooltip_show &&
        (r.tooltip
          .html(s.tooltip_contents.call(r, t, r.axis.getXAxisTickFormat(), r.getYFormat(o), r.color))
          .style('display', 'block'),
    ...
    (m.isLineType = function(t) {
      var e = this.config,
        i = c(t) ? t : t.id;
      return (
        !e.data_types[i] || 0 <= ['line', 'spline', 'area', 'area-spline', 'step', 'area-step'].indexOf(e.data_types[i])
      );
    }),
