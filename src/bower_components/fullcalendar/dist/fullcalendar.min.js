          ...
          return (
            ...
            (e.prototype.bindDateHandlerToEl = function(t, e, n) {
              ...
              this.el.on(e, function(t) {
                if (
                  !r(t.target).is(
                    i.segSelector + ':not(.fc-helper),' + i.segSelector + ':not(.fc-helper) *,.fc-more,a[data-goto]'
                  )
                )
                  return n.call(i, t);
              });
        ...
        o = (function() {
          ...
          return (
            ...
            (t.prototype.queryBoundingRect = function() {
              var t;
              return this.els.length > 0 && ((t = r.getScrollParent(this.els.eq(0))), !t.is(document))
                ? r.getClientRect(t)
                : null;
            }),
            ...
            (e.prototype.updateSize = function(e, n, i) {
              ...
              t.prototype.updateSize.call(this, e, n, i),
                ...
                n ||
                  ...
                  (o.left || o.right) &&
                    (s.compensateScroll(l, o), (r = this.computeScrollerHeight(e)), this.scroller.setHeight(r)),
          ...
          return (
            ...
            (t.prototype.buildEventDefs = function(t) {
              var e,
                ...
                s = [];
              for (
                !0 === n ? (r = [{}]) : i.isPlainObject(n) ? (r = [n]) : i.isArray(n) && ((r = n), (o = !0)), e = 0;
                e < r.length;
                e++
              )
                    ...
                    r.extend({}, e.AJAX_DEFAULTS, l, {
                      ...
                      success: function(e, i, s) {
                        ...
                        a.calendar.popLoading(),
                          e
                            ? ((l = o.applyAll(u, a, [e, i, s])), r.isArray(l) && (e = l), t(a.parseEventDefs(e)))
                            : n();
                      },
        ...
        H = (function() {
          ...
          return (
            ...
            (t.prototype.destroy = function() {
              this.view && this.clearView(),
                ...
                this.windowResizeProxy &&
                  (r(window).unbind('resize', this.windowResizeProxy), (this.windowResizeProxy = null)),
                u.default.unneeded();
            }),
            ...
            (t.prototype.applyTimezone = function(t) {
              ...
              return (
                i && ((e = n.clone().add(i)), t.time().asMilliseconds() - e.time().asMilliseconds() == 0 && (n = e)), n
              );
            }),
          ...
          return (
            ...
            (t.prototype.adjustActiveRange = function(t, e, n) {
              var i = t.getStart(),
                r = t.getEnd();
              return (
                this._view.usesMinMaxTime && (e < 0 && i.time(0).add(e), n > 864e5 && r.time(n - 864e5)),
                new o.default(i, r)
              );
            }),
                ...
                hitOver: function(n, l, c) {
                  ...
                  g && v
                    ? ((i = e
                      ...
                      i
                        ? ((h = d.buildMutatedEventInstanceGroup(p.id, i)), (f = s.isEventInstanceGroupAllowed(h)))
                        : (f = !1))
                    : (f = !1),
                  ...
                  t.hit && (u = t.hit),
                    ...
                    p && f
                      ? ((i = o.computeEventDropMutation(p, f, h)),
                        i
                          ? ((v = c.buildMutatedEventInstanceGroup(h.id, i)), (y = s.isEventInstanceGroupAllowed(v)))
                          : (y = !1))
                      : (y = !1),
          ...
          return (
            ...
            (e.prototype.renderSegList = function(t) {
              ...
              for (e = 0; e < o.length; e++)
                if ((n = o[e]))
                  for (
                    a.append(this.dayHeaderHtml(this.dayDates[e])), this.eventRenderer.sortEventSegs(n), i = 0;
                    i < n.length;
                    i++
                  )
                    a.append(n[i].el);
          ...
          return (
            ...
            (t.prototype.render = function() {
              ...
              t
                ? (e
                    ? e.empty()
                    : (e = this.el = i("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>")),
                  e
        ...
        s = (function(t) {
          ...
          return (
            ...
            (e.prototype.buildRenderRange = function(e, n, i) {
              ...
              return (
                this.opt('fixedWeekCount') && ((r = Math.ceil(l.diff(a, 'weeks', !0))), l.add(6 - r, 'weeks')),
                new o.default(a, l)
              );
            }),
            e
