  ...
  return (
          ...
          for (
            e += '<select class="dropdown controls ' + this.o.controls_cssclass + '">',
              this.ShowOnMenu(this.view_all_key) &&
                (e += '<option value="' + this.view_all_key + '">' + this.o.view_all_text + '</option>'),
              c = 0;
            c < this.ln;
            c += 1
          )
            this.ShowOnMenu(c) &&
              (e += '<option value="' + (c + 1) + '">' + (this.o.locations[c].title || '#' + (c + 1)) + '</option>');
          (e += '</select>'),
    ...
    (d = {
      ...
      getHtml: function() {
        ...
        for (
          this.ShowOnMenu(this.view_all_key) &&
            e.append(a('<li></li>').append(d.html_a.call(this, !1, this.view_all_key, this.o.view_all_text))),
            c = 0;
          c < this.ln;
          c++
        )
    ...
    (b.prototype.create_objMap = function() {
      ...
      for (b in this.o.styles)
        this.o.styles.hasOwnProperty(b) &&
          (0 === d && (this.o.map_options.mapTypeControlOptions = { mapTypeIds: [google.maps.MapTypeId.ROADMAP] }),
          d++,
      ...
      for (b in this.o.styles)
        this.o.styles.hasOwnProperty(b) &&
          (d++,
          this.oMap.mapTypes.set('map_style_' + d, new google.maps.StyledMapType(this.o.styles[b], { name: b })),
    ...
    (b.prototype.add_dragEv = function(a, b, c) {
      ...
      google.maps.event.addListener(c, 'drag', function(e) {
        ...
        if (
          (d.circles[a] && d.circles[a].setCenter(f), d.Polyline ? (g = 'Polyline') : d.Polygon && (g = 'Polygon'), g)
        ) {
        ...
        for (b = 0; b < this.ln; b++)
          (c = this.create_objPoint(b)),
            0 === b
              ...
              : b === this.ln - 1
                ? (f = c.position)
                : ((d = this.o.locations[b].stopover === !0), h.push({ location: c.position, stopover: d })),
      ...
      this.CloseInfoWindow(),
        1 === this.ln
          ? (this.o.map_options.set_center
              ? this.oMap.setCenter(
                  new google.maps.LatLng(this.o.map_options.set_center[0], this.o.map_options.set_center[1])
                )
