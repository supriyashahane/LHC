          ...
          setTimeout(function() {
            if (d) null != c && null !== c.$menu && void 0 !== c.$menu && c.$menu.trigger('contextmenu:hide');
              ...
              if (document.elementFromPoint && c.$layer) {
                if (
                  (c.$layer.hide(),
                  (s = document.elementFromPoint(r - p.scrollLeft(), u - p.scrollTop())).isContentEditable)
                ) {
      ...
      key: function(e) {
        ...
        if ((o(e.target), !(t.$menu && parseInt(n, 10) > parseInt(t.$menu.css('zIndex'), 10)))) {
          switch (e.keyCode) {
            ...
            case 27:
              return (
                b.keyStop(e, t), void (null !== t.$menu && void 0 !== t.$menu && t.$menu.trigger('contextmenu:hide'))
              );
            default:
    ...
    $ = {
      ...
      resize: function(e, t) {
        ...
        e.css({ position: 'absolute', display: 'block' }),
          e.data(
            'width',
            (n = e.get(0)).getBoundingClientRect ? Math.ceil(n.getBoundingClientRect().width) : e.outerWidth() + 1
          ),
      ...
      update: function(s, i) {
        ...
        return (
          s.$menu.children().each(function() {
            ...
            if (
              ((e = m.isFunction(o.visible) ? o.visible.call(c, n, i) : void 0 === o.visible || !0 === o.visible) &&
                (l = !0),
              t[e ? 'show' : 'hide'](),
              t[a ? 'addClass' : 'removeClass'](i.classNames.disabled),
              m.isFunction(o.icon) &&
                (t.removeClass(o._icon), (o._icon = o.icon.call(this, c, t, n, o)), t.addClass(o._icon)),
              o.type)
            )
      ...
      layer: function(e, t) {
        ...
        return (
          void 0 === document.body.style.maxWidth && n.css({ position: 'absolute', height: m(document).height() }), n
        );
      },
      processPromises: function(e, t, n) {
        function o(e, t, n) {
          void 0 === n
            ? ((n = {
                error: { name: 'No items and no error item', icon: 'context-menu-icon context-menu-icon-quit' }
              }),
              window.console &&
        ...
        case 'html5':
          ((!m.support.htmlCommand && !m.support.htmlMenuitem) || ('boolean' == typeof t && t)) &&
            m('menu[type="context"]')
              .each(function() {
                this.id &&
                  m.contextMenu({ selector: '[contextmenu=' + this.id + ']', items: m.contextMenu.fromMenu(this) });
              })
              .css('display', 'none');
          break;
        default:
