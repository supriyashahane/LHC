...
!(function(e, t) {
  ...
  function n() {
    ...
    _extends(this, {
      ...
      misbehaves: function(i) {
        t.isNativeEvent(i) &&
          (t.behavesOk(i), e(document).on('change.inputevent', i.data.selector, t.fakeInputEvent), t.fakeInputEvent(i));
      },
      ...
      install: function() {
        if (!i.inputEventPatched) {
          ...
          for (
            var n = ['select', 'input[type="checkbox"]', 'input[type="radio"]', 'input[type="file"]'], r = 0;
            r < n.length;
            r++
          ) {
            var s = n[r];
    ...
    a = {
      ...
      parse: {
        ...
        regexp: function(e) {
          ...
          return (
            /^\/.*\/(?:[gimy]*)$/.test(e)
              ? ((t = e.replace(/.*\/([gimy]*)$/, '$1')), (e = e.replace(new RegExp('^/(.*?)/' + t + '$'), '$1')))
              : (e = '^' + e + '$'),
            new RegExp(e, t)
          );
        }
  ...
  l.prototype = {
    ...
    asyncIsValid: function(e, t) {
      return (
        a.warnOnce('asyncIsValid is deprecated; please use whenValid instead'), this.whenValid({ group: e, force: t })
      );
    },
  ...
  h.prototype = {
    validate: function(e, t) {
      ...
      if (this.validateDate && i._isDateInput())
        return (
          (arguments[0] = a.parse.date(arguments[0])), null !== arguments[0] && this.validateDate.apply(this, arguments)
        );
      if (this.validateNumber)
        return !isNaN(e) && ((arguments[0] = parseFloat(arguments[0])), this.validateNumber.apply(this, arguments));
    ...
    _submit: function(t) {
      if (!1 !== this._trigger('submit')) {
        if (t) {
          ...
          0 === i.length &&
            (i = e('<input class="parsley-synthetic-submit-button" type="hidden">').appendTo(this.$element)),
  ...
  A.prototype = {
    validate: function(t) {
      arguments.length >= 1 &&
        !e.isPlainObject(t) &&
        (a.warnOnce('Calling validate on a parsley field without passing arguments as an object is deprecated.'),
        (t = { options: t }));
    ...
    _isRequired: function() {
      return (
        'undefined' != typeof this.constraintsByName.required && !1 !== this.constraintsByName.required.requirements
      );
    },
    _trigger: function(e) {
    ...
    _handleWhitespace: function(e) {
      return (
        !0 === this.options.trimValue &&
          a.warnOnce('data-parsley-trim-value="true" is deprecated, please use data-parsley-whitespace="trim"'),
  ...
  P.prototype = {
    init: function(e) {
      return (
        ...
        (a.checkAttr(this.element, this.options.namespace, 'validate') && !this.$element.is(this.options.inputs))
    ...
    e.each(a, function(e, t) {
      'function' == typeof t &&
        (window.ParsleyUtils[e] = function() {
          return (
            a.warnOnce('Accessing `window.ParsleyUtils` is deprecated. Use `window.Parsley.Utils` instead.'),
  ...
  (e.listen = function(e, n) {
    ...
    if (
      (R(),
      'object' == typeof arguments[1] && 'function' == typeof arguments[2] && ((r = arguments[1]), (n = arguments[2])),
      'function' != typeof n)
    )
