    ...
    save: function(submitValue) {
      ...
      var pk = typeof this.options.pk === 'function' ? this.options.pk.call(this.options.scope) : this.options.pk,
        ...
        send = !!(
          ...
          (this.options.url &&
            (this.options.send === 'always' || (this.options.send === 'auto' && pk !== null && pk !== undefined)))
        ),
        params;
    ...
    init: function() {
      ...
      switch (this.options.autotext) {
        ...
        case 'auto':
          ...
          doAutotext =
            !$.trim(this.$element.text()).length && this.value !== null && this.value !== undefined && !isValueByText;
          break;
        default:
          doAutotext = false;
      }
  ...
  $.extend($.fn.editableContainer.Popup.prototype, {
    ...
    show: function(closeAll) {
      ...
      var $label = $('<label>').text(
          this.options.title || this.$element.data('title') || this.$element.data('originalTitle')
        ),
        $content = $('<div>')
          .append($label)
          .append(this.$form);
        ...
        $table
          ...
          .width(
            (document.defaultView &&
              ...
              parseFloat(document.defaultView.getComputedStyle(this.$tip[0], null).width)) ||
              this.$tip.width()
          )
          .find('td')
          .eq(3)
