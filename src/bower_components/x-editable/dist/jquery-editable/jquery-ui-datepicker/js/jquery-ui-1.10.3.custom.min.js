...
(function(t, e) {
  ...
  t.extend(i.prototype, {
    ...
    _generateHTML: function(t) {
      ...
      if ((0 > Z && ((Z += 12), te--), $))
        for (
          e = this._daylightSavingAdjust(new Date($.getFullYear(), $.getMonth() - Q[0] * Q[1] + 1, $.getDate())),
            e = G && G > e ? G : e;
        ...
        for (w = '', this.maxRows = 4, D = 0; Q[1] > D; D++) {
          ...
          for (
            ...
            (N = (x + c) % 7),
              (S +=
                '<th' +
                ((x + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : '') +
                '>' +
                "<span title='" +
                d[N] +
                "'>" +
          ...
          Z++,
            ...
            (M +=
              '</tbody></table>' +
              (q ? '</div>' + (Q[0] > 0 && D === Q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '') : '')),
            (w += M);
        }
        y += w;
      }
