    ...
    return (
      a.each(b, function(e) {
        ...
        'object' == typeof c[e] && null !== c[e]
          ? (f && a.isArray(c[e]) && (f = a.isArray(b[e]) && c[e].length === b[e].length), (f = f && d(b[e], c[e])))
              ...
              ('json' === d.dataType && 'object' == typeof b.responseText
                ...
                : 'xml' === d.dataType
                  ...
                  : 'object' == typeof b.responseText && null !== b.responseText
                    ? ((b.contentType = 'application/json'), (this.responseText = JSON.stringify(b.responseText)))
        ...
        if ((f = g(w[i], e))) {
          ...
          return e.dataType && 'JSONP' === e.dataType.toUpperCase() && (d = l(e, f, c))
            ...
            : ((c.crossDomain = !1),
              ...
              (f.global = e.global),
              f.isTimeout &&
                (f.responseTime > 1 ? (c.timeout = f.responseTime - 1) : ((f.responseTime = 2), (c.timeout = 1))),
        ...
        if (
          ...
          return a.mockjaxSettings.log
            ...
            : a.mockjaxSettings.logger && a.mockjaxSettings.logger[a.mockjaxSettings.logLevelMethods[d]]
              ? a.mockjaxSettings.logger[a.mockjaxSettings.logLevelMethods[d]].apply(a.mockjaxSettings.logger, c)
              : void 0;
      },
      debug: function(a, b) {
