      ...
      function maskScope(actionObj, maskset, opts) {
        ...
        function getMaskTemplate(baseOnInput, minimalPos, includeMode, noJit, clearOptionalTail) {
            ...
            if (!0 === baseOnInput && getMaskSet().validPositions[pos])
              (test = (testPos =
                ...
                (!0 === getMaskSet().validPositions[pos].generatedInput ||
                  (getMaskSet().validPositions[pos].input == opts.skipOptionalPartCharacter && pos > 0))
              ...
              pos < lvp ||
              ('number' == typeof jitMasking && isFinite(jitMasking) && jitMasking > pos)
                ? maskTemplate.push(!1 === includeMode ? test.nativeDef : getPlaceholder(pos, test))
                : test.jit && test.optionalQuantifier !== undefined && (pos, 0);
            }
          ...
          return (
            ...
            (!1 === includeMode && getMaskSet().maskLength !== undefined) || (getMaskSet().maskLength = pos - 1),
            (opts.greedy = greedy),
            maskTemplate
          );
        }
        ...
        function determineTestTemplate(pos, tests) {
          for (
            var tstLocator,
              closest,
              bestMatch,
              targetLocator = getLocator(getTest((pos = pos > 0 ? pos - 1 : 0))),
              ndx = 0;
            ndx < tests.length;
            ndx++
          ) {
        ...
        function getTests(pos, ndxIntlzr, tstPs) {
            ...
            function handleMatch(match, loopNdx, quantifierRecurse) {
                      ...
                      if (
                        (!0 === match.isQuantifier
                          ...
                          : !0 === match.isOptional
                            ...
                            : !0 === match.isAlternate && (firstMatch = isFirstMatch(latestMatch, match)),
                        firstMatch)
                      )
                        return !1;
                    }),
              ...
              function resolveNdxInitializer(pos, alternateNdx, targetAlternation) {
                ...
                if (
                  ...
                  return (bestMatch.mloc[alternateNdx] || bestMatch.mloc[bestMatchAltIndex] || bestMatch.locator).slice(
              ...
              function isSubsetOf(source, target) {
                ...
                return opts.regex && null !== source.match.fn && null !== target.match.fn
                  ? -1 !==
                ...
                if (
                  ...
                  if (locNdx !== undefined) {
                    if (
                      ...
                      targetMatch.mloc[locNdx] === undefined &&
                ...
                if (match.isGroup && quantifierRecurse !== match) {
                  ...
                  if ((match = resolveTestFromToken(match, ndxInitializer, loopNdx, quantifierRecurse))) {
                    if (
                      ...
                      quantifierRecurse !== undefined || !isFirstMatch(latestMatch, optionalToken))
                    )
                      return !0;
                  ...
                  if (-1 === altIndex || 'string' == typeof altIndex) {
                    ...
                    if (getMaskSet().excludes[pos]) {
                      for (
                        var altIndexArrClone = altIndexArr.slice(), i = 0, el = getMaskSet().excludes[pos].length;
                        i < el;
                        i++
                      )
                  ...
                  for (
                    ...
                    if ((match = handleMatch(tokenGroup, [qndx].concat(loopNdx), tokenGroup))) {
                      if (
                        (((latestMatch = matches[matches.length - 1].match).optionalQuantifier =
          ...
          if (pos > -1) {
            if (ndxIntlzr === undefined) {
              ...
              test !== undefined &&
                previousPos > -1 &&
                ((ndxInitializer = (function(pos, tests) {
                  var locator = [];
                  return (
                    $.isArray(tests) || (tests = [tests]),
                    tests.length > 0 &&
                      (tests[0].alternation === undefined
                        ? 0 === (locator = determineTestTemplate(pos, tests.slice()).locator.slice()).length &&
        ...
        function alternate(pos, c, strict, fromSetValid, rAltPos) {
          ...
          if (-1 === lAltPos && rAltPos === undefined) alternation = (prevAltPos = getTest((lastAlt = 0))).alternation;
          else
          ...
          if (alternation !== undefined) {
            ...
            for (i = decisionPos; i < getLastValidPosition(undefined, !0) + 1; i++)
              (validPos = getMaskSet().validPositions[i]) && !0 !== validPos.generatedInput
            ...
            for (; getMaskSet().excludes[decisionPos] && getMaskSet().excludes[decisionPos].length < 10; ) {
              ...
              for (
                getMaskSet().tests[decisionPos] = undefined, resetMaskSet(!0), isValidRslt = !0;
              ...
              for (
                getMaskSet().excludes[decisionPos].push(decisionTaker), i = decisionPos;
        ...
        function trackbackPositions(originalPos, newPos, fillOnly) {
          ...
          if (originalPos === undefined)
            for (originalPos = newPos - 1; originalPos > 0 && !getMaskSet().validPositions[originalPos]; originalPos--);
          for (var ps = originalPos; ps < newPos; ps++) {
            if (getMaskSet().validPositions[ps] === undefined && !isMask(ps, !0))
              if (0 == ps ? getTest(ps) : getMaskSet().validPositions[ps - 1]) {
        ...
        function revalidateMask(pos, validTest, fromSetValid, validatedPos) {
          function IsEnclosedStatic(pos, valids, selection) {
            ...
            if (
              posMatch !== undefined &&
              ((null === posMatch.match.fn && !0 !== posMatch.match.optionality) || posMatch.input === opts.radixPoint)
            ) {
              var prevMatch =
                  selection.begin <= pos - 1
                    ? valids[pos - 1] && null === valids[pos - 1].match.fn && valids[pos - 1]
                    : valids[pos - 1],
                nextMatch =
                  selection.end > pos + 1
                    ? valids[pos + 1] && null === valids[pos + 1].match.fn && valids[pos + 1]
          ...
          EventHandlers = {
            ...
            keypressEvent: function(e, checkval, writeOut, strict, ndx) {
              ...
              if (k) {
                ...
                if (opts._radixDance && opts.numericInput) {
                  ...
                  pos.begin <= caretPos &&
                    (k === opts.radixPoint.charCodeAt(0) && (offset = 1), (pos.begin -= 1), (pos.end -= 1));
                }
                ...
                if (
                  ...
                  if (
                    ...
                    (keydown.keyCode = opts.numericInput ? Inputmask.keyCode.BACKSPACE : Inputmask.keyCode.DELETE),
                      ...
                      iphone || !1 !== opts.insertMode || caret(input, caret(input).begin - 1);
                  }
                  e.preventDefault();
                }
              }
              ...
              if (e.cancelable) {
                ...
                switch (e.inputType) {
                  ...
                  case 'deleteContentBackward':
                    return (
                      ((keydown = new $.Event('keydown')).keyCode = Inputmask.keyCode.BACKSPACE),
                      EventHandlers.keydownEvent.call(input, keydown),
                      e.preventDefault()
                    );
                  ...
                  case 'deleteContentForward':
                    var keydown;
                    return (
                      ((keydown = new $.Event('keydown')).keyCode = Inputmask.keyCode.DELETE),
                      EventHandlers.keydownEvent.call(input, keydown),
                      e.preventDefault()
                    );
                }
            ...
            setValueEvent: function(e) {
              ...
              $.isFunction(opts.onBeforeMask) && (value = opts.onBeforeMask.call(inputmask, value, opts) || value),
                checkVal(this, !0, !1, (value = value.split(''))),
                (undoValue = getBuffer().join('')),
        ...
        function caret(input, begin, end, notranslate) {
          ...
          if (
            ...
            (begin = notranslate ? begin : translatePosition(begin)),
              (end = 'number' == typeof (end = notranslate ? end : translatePosition(end)) ? end : begin);
            var scrollCalc =
              parseInt(
            ...
            if (
              ...
              iphone || !1 !== opts.insertMode || begin !== end || end++,
        ...
        function clearOptionalTail(buffer) {
          buffer.length = 0;
          for (
            var lmnt, template = getMaskTemplate(!0, 0, !0, undefined, !0);
            (lmnt = template.shift()) !== undefined;
            ...
            (k === Inputmask.keyCode.BACKSPACE && (pos.end - pos.begin < 1 || !1 === opts.insertMode)
              ? ((pos.begin = seekPrevious(pos.begin)),
                getMaskSet().validPositions[pos.begin] !== undefined &&
                  ...
                  pos.begin--,
                !1 === opts.insertMode && pos.end !== getMaskSet().maskLength && pos.end--)
              : k === Inputmask.keyCode.DELETE &&
                pos.begin === pos.end &&
                ((pos.end =
                  isMask(pos.end, !0) &&
        ...
        if (
          ...
          switch (actionObj.action) {
                                    ...
                                    $.valHooks[type] = {
                                      ...
                                      set: function(elem, value) {
                                        ...
                                        return (
                                          ...
                                          elem.inputmask && $elem.trigger('setvalue', [value]),
                                          result
                                        );
                                      },
                                      inputmaskpatch: !0
            ...
            case 'isValid':
              actionObj.value
                ? ((valueBuffer = actionObj.value.split('')), checkVal.call(this, undefined, !0, !0, valueBuffer))
              ...
              if (el && el.inputmask)
                $.data(el, '_inputmask_opts', null),
                  ...
                  el.inputmask.colorMask &&
                    ((colorMask = el.inputmask.colorMask).removeChild(el),
          ...
          analyseMask: function(mask, regexMask, opts) {
              ...
              if (regexMask)
                    ...
                    $.each(element.split(''), function(ndx, lmnt) {
                      (prevMatch = mtoken.matches[position - 1]),
                        mtoken.matches.splice(position++, 0, {
                          ...
                          optionality: !1,
                          newBlockMarker:
                            prevMatch === undefined ? 'master' : prevMatch.def !== lmnt && null !== prevMatch.fn,
                          casing: null,
                ...
                maskdef && !escaped
                  ? mtoken.matches.splice(position++, 0, {
                      ...
                      optionality: !1,
                      newBlockMarker:
                        prevMatch === undefined ? 'master' : prevMatch.def !== (maskdef.definitionSymbol || element),
                  ...
                  : (mtoken.matches.splice(position++, 0, {
                      ...
                      optionality: !1,
                      newBlockMarker:
                        prevMatch === undefined ? 'master' : prevMatch.def !== element && null !== prevMatch.fn,
                      casing: null,
            ...
            function defaultCase() {
              if (openenings.length > 0) {
                if (
                  (insertTestDefinition((currentOpeningToken = openenings[openenings.length - 1]), m),
              ...
              if (escaped) defaultCase();
                ...
                switch (m.charAt(0)) {
                  ...
                  case opts.quantifiermarker[0]:
                    ...
                    var matches =
                      openenings.length > 0 ? openenings[openenings.length - 1].matches : currentToken.matches;
                  ...
                  for (var match in ((maskToken.matches = maskToken.matches.reverse()), maskToken.matches))
                    if (maskToken.matches.hasOwnProperty(match)) {
                      ...
                      maskToken.matches[match].matches !== undefined
                        ...
                        : (maskToken.matches[match] = ((st = maskToken.matches[match]) === opts.optionalmarker[0]
    ...
    (factory = function($, Inputmask) {
      ...
      function parse(format, dateObjValue, opts) {
        for (var match, mask = ''; (match = getTokenizer(opts).exec(format)); ) {
          ...
          else if (formatCode[match[0]]) mask += formatCode[match[0]][3].call(dateObjValue.date);
          else mask += match[0];
        }
        return mask;
      }
          ...
          if ((opts.min && opts.min[targetProp]) || (opts.max && opts.max[targetProp])) {
            ...
            for (
              correctedValue = value.replace(/[^0-9]/g, ''),
                correctedValue += (min.indexOf(correctedValue) < max.indexOf(correctedValue) ? max : min)
                  .toString()
                  .substr(correctedValue.length);
              !new RegExp(targetValidator).test(correctedValue);
            ...
            postValidation: function(buffer, currentResult, opts) {
              ...
              return (
                result &&
                  ...
                  (result =
                    (result = (function(dateParts, currentResult) {
                      return (
                  ...
                  'd' === match[0].charAt(0)
                    ...
                    : 'm' === match[0].charAt(0)
                      ...
                      : 'yyyy' === match[0]
                        ...
                        : 'y' === match[0].charAt(0) && (date += pad(today.getYear(), match[0].length));
          ...
          numeric: {
            ...
            preValidation: function(buffer, pos, c, isSelection, opts, maskset) {
              ...
              if (
                ...
                if (-1 !== radixPos && maskset.validPositions[radixPos] !== undefined)
            ...
            postValidation: function(buffer, currentResult, opts) {
              ...
              if (
                ((processValue = (processValue = (processValue = (processValue = processValue.replace(
                  suffix,
                  ''
                )).replace(new RegExp(Inputmask.escapeRegex(opts.groupSeparator), 'g'), '')).replace(
            ...
            onUnMask: function(maskedValue, unmaskedValue, opts) {
              ...
              return (
                (processValue = (processValue = processValue.replace(opts.suffix, '')).replace(
            ...
            isComplete: function(buffer, opts) {
              ...
              return (
                (maskedValue = (maskedValue = (maskedValue = (maskedValue = (maskedValue = maskedValue.replace(
                  new RegExp('^' + Inputmask.escapeRegex(opts.negationSymbol.front)),
                  '-'
                )).replace(new RegExp(Inputmask.escapeRegex(opts.negationSymbol.back) + '$'), '')).replace(
                  opts.prefix,
                  ''
                )).replace(opts.suffix, '')).replace(
              ...
              (opts.phoneCodes &&
                ...
                ((function reduceVariations(masks, previousVariation, previousmaskGroup) {
                  ...
                  (mask = mask.substr(1, mask.length - 2)).split(
                    opts.groupmarker[1] + opts.alternatormarker + opts.groupmarker[0]
                  )
                ),
