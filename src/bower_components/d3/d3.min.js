...
(function(t, n) {
  ...
  function O(t, n, e, r, i, o, a) {
    var u,
      ...
      d = new Array(l);
    for (u = 0; u < l; ++u)
      (f = n[u]) && ((d[u] = c = ms + a.call(f, f.__data__, u, n)), c in s ? (i[u] = f) : (s[c] = f));
    for (u = 0; u < h; ++u)
  ...
  function kt(t) {
    ...
    return (
      ...
      (n = Ss.exec(t))
        ? ((n = parseInt(n[1], 16)),
          new Lt(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1))
        : (n = Es.exec(t))
          ? Ct(parseInt(n[1], 16))
          : (n = ks.exec(t))
  ...
  function Pn(t, n, e, r, i, o) {
    ...
    (function(t, n, e) {
      ...
      function i(n) {
        for (
          var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(o), (e.state = Ol), 1),
            i = -1,
            u = a.length;
          ++i < u;
            ...
            .on(
              ...
              function() {
                switch (t.event.keyCode) {
                  ...
                  case 18:
                    A === vh &&
                      (T && ((d = p - y * T), (u = c + y * T)), N && ((v = g - _ * N), (l = h + _ * N)), (A = gh), o());
                    break;
                  case 32:
                    (A !== vh && A !== gh) ||
                      (T < 0 ? (d = p - y) : T > 0 && (u = c - y),
    ...
    return (
      ...
      (e.extent = function(t) {
        return arguments.length
          ? ((c = 'function' == typeof t ? t : $n([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])), e)
          : c;
      }),
      (e.filter = function(t) {
              ...
              ? (i = d[s])
                ? (delete p[n.end],
                  ...
                  n === i
                    ...
                    : (d[n.start] = p[i.end] = { start: n.start, end: i.end, ring: n.ring.concat(i.ring) }))
              ...
              : (n = d[s])
                ? (i = p[c])
                  ? (delete d[n.start],
                    ...
                    n === i
                      ? (n.ring.push(a), r(n.ring))
                      : (d[i.start] = p[n.end] = { start: i.start, end: n.end, ring: i.ring.concat(n.ring) }))
  ...
  function Ae(t, n, e) {
    for (var r = t.width, i = t.height, o = 1 + (e << 1), a = 0; a < i; ++a)
      for (var u = 0, f = 0; u < r + e; ++u)
        u < r && (f += t.data[u + a * r]),
          u >= e &&
            (u >= o && (f -= t.data[u - o + a * r]), (n.data[u - e + a * r] = f / Math.min(u + 1, r - 1 + o - u, o)));
  }
  function Te(t, n, e) {
  ...
  function zr(t, n) {
    ...
    if (Ad) {
      ...
      c ^ (u * xd < f && f < u * t)
        ? (o = i[1] * Zd) > md && (md = o)
        : ((f = ((f + 360) % 360) - 180),
          c ^ (u * xd < f && f < u * t) ? (o = -i[1] * Zd) < _d && (_d = o) : (n < _d && (_d = n), n > md && (md = n))),
        c
          ? t < xd
  ...
  function Xr(t, n) {
    ...
    var e = np((n *= Qd)),
      ...
      o = ap(n),
      a = tp(
        fp((a = Fd * o - Id * i) * a + (a = Id * r - Bd * o) * a + (a = Bd * i - Fd * r) * a),
        Bd * r + Fd * i + Id * o
      );
  ...
  function oi(t, n, e, r, i, o) {
    if (e) {
      ...
      null == i
        ? ((i = n + r * Wd), (o = n - f / 2))
        : ((i = ai(a, i)), (o = ai(a, o)), (r > 0 ? i < o : i > o) && (i += r * Wd));
  ...
  function hi(t, n) {
    ...
    for (var f = 0, c = t.length; f < c; ++f)
      if ((l = (s = t[f]).length))
        for (
          var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + $d, v = ap(p), g = np(p), y = 0;
          y < l;
          ++y, d = b, v = x, g = w, h = _
        ) {
          var _ = s[y],
  ...
  function Pi() {
    ...
    return (
      ...
      (t.precision = function(n) {
        return arguments.length
          ? ((b = +n), (l = ki(u, a, 90)), (h = Ci(r, e, b)), (d = ki(c, f, 90)), (p = Ci(o, i, b)), t)
          : b;
      }),
      ...
      (n.clipExtent = function(t) {
        return arguments.length
          ? ((N =
              null == t
                ? ((T = a = u = f = null), zi)
                : yi((T = +t[0][0]), (a = +t[0][1]), (u = +t[1][0]), (f = +t[1][1]))),
            r())
          : null == T
            ? null
            : [[T, a], [u, f]];
    ...
    function l(n, r, i, o) {
      if ((null == n && (n = 10), 'number' == typeof n)) {
        ...
        u === A.length
          ? ((o = d(r / Wg, i / Wg, n)), (n = t))
          : u
            ? ((o = (u = A[a / A[u - 1][2] < A[u][2] / a ? u - 1 : u])[1]), (n = u[0]))
    ...
    return (
      ...
      (h.ticks = function(t, n) {
        var e,
          ...
          a = o < i;
        return (
          a && ((e = i), (i = o), (o = e)), (e = l(t, i, o, n)), (e = e ? e.range(i, o + 1) : []), a ? e.reverse() : e
        );
      }),
  ...
  function Df(t) {
    function n() {
      ...
      if (
        (a || (a = n = oe()),
        t(a, +i.apply(this, ((u[0] = f), u)), +o.apply(this, u), +i.apply(this, ((u[0] = c), u)), +o.apply(this, u)),
        n)
      )
  ...
  function Uc(t) {
    ...
    if ((tb.insert(n, f), n || e)) {
      if (n === e)
        return zc(n), (e = Rc(n.site)), tb.insert(f, e), (f.edge = e.edge = Mc(n.site, f.site)), Pc(n), void Pc(e);
      if (e) {
        zc(n), zc(e);
        var c = n.site,
          s = c[0],
    ...
    if (
      ...
      (function(t, n, e, r) {
        for (var i, o = rb.length; o--; )
          (Sc((i = rb[o]), t, n, e, r) &&
            Nc(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > ab || Math.abs(i[0][1] - i[1][1]) > ab)) ||
            delete rb[o];
      })(a, u, f, c),
        (function(t, n, e, r) {
          var i,
          ...
          if (y) {
            ...
            for (i = 0, y = null; i < g; ++i)
              (o = nb[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && ((x = m), (y = o));
            if (y) {
              var w = [t, n],
                M = [t, r],
                A = [e, r],
  ...
  Nt(Et, kt, {
    ...
    Nt(
      ...
      St(Et, {
        brighter: function(t) {
          return (
            (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Lt(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker: function(t) {
  ...
  (id.copy = function() {
    ...
    for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
      for (var i = 0; i < 4; ++i)
        (n = r.source[i]) &&
          (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Xe(n)));
    return e;
  }),
    (id.add = function(t) {
        ...
        if (!(!(v = f.node) || (i = f.x0) > h || (o = f.y0) > d || (a = f.x1) < s || (u = f.y1) < l))
          if (v.length) {
            ...
            p.push(
              ...
              (c = ((n >= y) << 1) | (t >= g)) &&
                ((f = p[p.length - 1]), (p[p.length - 1] = p[p.length - 1 - c]), (p[p.length - 1 - c] = f));
          } else {
              ...
              : i !== u &&
                ...
                (r = (function(t, n, e, r) {
                  var i,
                    ...
                    a = ap(t - e);
                  return Jd(a) > Hd
                    ? Kd((ap(n) * (o = np(r)) * ap(e) - ap(r) * (i = np(n)) * ap(t)) / (i * o * a))
                    : (n + r) / 2;
                })(e, r, o, a)),
                t.point(i, r),
                t.lineEnd(),
    ...
    (_c.prototype = {
      ...
      insert: function(t, n) {
        ...
        if (t) {
          ...
          this._
            ? ((t = wc(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
        ...
        if (
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C && ((n.C = !1), (i.C = !0), mc(this, i), (n = i.R)), (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                ...
                ((n = i.L).C && ((n.C = !1), (i.C = !0), xc(this, i), (n = i.L)), (n.L && n.L.C) || (n.R && n.R.C))
              ) {
  ...
  (jc.prototype = Ic.prototype),
    ...
    (t.thresholdFreedmanDiaconis = function(t, e, r) {
      return (
        (t = rs.call(t, i).sort(n)), Math.ceil((r - e) / (2 * (v(t, 0.75) - v(t, 0.25)) * Math.pow(t.length, -1 / 3)))
      );
    }),
    ...
    (t.contourDensity = function() {
      ...
      return (
        ...
        (t.thresholds = function(n) {
          return arguments.length
            ? ((_ = 'function' == typeof n ? n : Array.isArray(n) ? me(Uh.call(n)) : me(n)), t)
            : _;
        }),
    ...
    (t.forceSimulation = function(t) {
      ...
      function e() {
        ...
        for (
          ...
          null == (e = t[n]).fx ? (e.x += e.vx *= s) : ((e.x = e.fx), (e.vx = 0)),
    ...
    (t.geoCentroid = function(t) {
      ...
      var n = Dd,
        ...
        i = n * n + e * e + r * r;
      return i < Xd &&
        ((n = zd), (e = Rd), (r = Ld), Ed < Hd && ((n = kd), (e = Cd), (r = Pd)), (i = n * n + e * e + r * r) < Xd)
        ? [NaN, NaN]
      ...
      return (
        ...
        (t.translate = function(t) {
          ...
          return (
            (i = f
              .translate(t)
              .clipExtent([[r - 0.455 * e, u - 0.238 * e], [r + 0.455 * e, u + 0.238 * e]])
              .stream(l)),
            (o = c
        ...
        clipExtent: function(i) {
          return arguments.length
            ? ((p =
                null == i
                  ? ((d = n = e = r = null), zi)
                  : yi((d = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))),
              t())
            : null == d
              ? null
              : [[d, n], [e, r]];
    ...
    (t.tree = function() {
      ...
      function n(t) {
        ...
        t.parent.A = (function(t, n, e) {
          if (n) {
            for (
              var r, o = t, a = t, u = n, f = o.parent.children[0], c = o.m, s = a.m, l = u.m, h = f.m;
              (u = aa(u)), (o = oa(o)), u && o;
        ...
        if ((f || (f = t = oe()), l < s && ((c = l), (l = s), (s = c)), l > M_))
          if (p > N_ - M_)
            f.moveTo(l * __(h), l * x_(h)),
              f.arc(0, 0, l, h, d, !v),
              s > M_ && (f.moveTo(s * __(d), s * x_(d)), f.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
    ...
    (t.pie = function() {
      function t(t) {
        ...
        for (
          ...
          (f = p[u]),
            (s = g + ((l = v[f]) > 0 ? l * c : 0) + b),
            (v[f] = { data: t[f], index: u, value: l, startAngle: g, endAngle: s, padAngle: _ });
        return v;
      }
      var n = Nf,
        e = Tf,
    ...
    (t.symbol = function() {
      function t() {
        var t;
        if ((r || (r = t = oe()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t))
    ...
    (t.zoom = function() {
      ...
      return (
        ...
        (n.extent = function(t) {
          return arguments.length
            ? ((y = 'function' == typeof t ? t : Fc([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])), n)
            : y;
        }),
