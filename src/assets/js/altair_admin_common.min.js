...
function scrollbarWidth() {
  ...
  e = i[0];
  return (
    jQuery('body').append(e), (a = a.offsetWidth), i.css('overflow', 'scroll'), (e = e.clientWidth), i.remove(), a - e
  );
}
      ...
      'single' !== this.settings.mode
        ? ((n = i = this),
          ...
          function() {
            ...
            t.apply(i, arguments),
              i.$control.on('click', '.' + a.className, function(e) {
        ...
        : (function(e, i) {
            ...
            function() {
              if (i.append) {
                var s = $(t.$input.context).attr('id'),
                  r = ($('#' + s), t.settings.render.item);
                t.settings.render.item = function(i) {
                  return (
                    (a = r.apply(e, arguments)),
                    (t = n),
                    (s = a.search(/(<\/[^>]+>\s*)$/)),
                    a.substring(0, s) + t + a.substring(s)
                  );
                  var a, t, s;
                };
              }
...
(altair_page_onload = {
  ...
  (altair_forms = {
    ...
    parsley_validation_config: function() {
      window.ParsleyConfig = {
        ...
        classHandler: function(e) {
          var i = e.$element;
          if (i.is(':checkbox') || i.is(':radio') || i.parent().is('label') || $(i).is('[data-md-selectize]'))
    ...
    dynamic_fields: function(e, i, a) {
      ...
      (e ? $(e).find('[data-dynamic-fields]') : $('[data-dynamic-fields]')).each(function() {
        ...
        a || t(e, n),
          e
            .on('click', '.btnSectionClone', function(a) {
              a.preventDefault(),
                e
                  .find('.btnSectionClone')
                  .replaceWith('<a href="#" class="btnSectionRemove"><i class="material-icons md-24">&#xE872;</i></a>');
  ...
  (altair_main_sidebar = {
    init: function() {
      $sidebar_main.length &&
        (lsTest() &&
          (null !== localStorage.getItem('altair_sidebar_mini') && $body.addClass('sidebar_mini'),
          null !== localStorage.getItem('altair_sidebar_slim') && $body.addClass('sidebar_slim')),
          ...
          .each(function() {
            $(this).children('ul').length
              ? ($(this).addClass('sidebar_submenu'),
                $(this).find('.act_item').length && $(this).addClass('current_section'))
  ...
  (altair_top_bar = {
    init: function() {
      $topBar.length &&
        ($topBar.hasClass('top_bar_static')
    ...
    _overflow: function() {
      if ($pageOverflow.length) {
        function e() {
          ...
          $pageOverflow.children('.uk-overflow-container').length
            ? $pageOverflow.children('.uk-overflow-container').height(e)
            : $pageOverflow.height(e);
        }
        e(),
          $window.on('debouncedresize', function() {
            e();
  ...
  (altair_md = {
      ...
      $('.md-card-fullscreen-activate').on('click', function() {
        ...
        if (!e.hasClass('md-card-fullscreen')) {
          var i = e.height(),
            ...
            n = $body.scrollTop(),
            s = e.offset();
          e.after('<div class="md-card-placeholder" style="width:' + t + 'px;height:' + i + 'px;"/>'),
            e
              .addClass('md-card-fullscreen')
              .css({ width: t, height: i, left: s.left, top: s.top - n })
              .velocity(
                { left: 0, top: 0 },
                {
                  duration: 400,
                  ...
                  begin: function(i) {
                    ...
                    a.length
                      ...
                      : e.append(
                          '<span class="md-icon md-card-fullscreen-deactivate material-icons uk-position-top-right" style="margin:10px 10px 0 0">&#xE5CD;</span>'
                        ),
                      altair_page_content.hide_content_sidebar();
                  }
                }
        ...
        $page_content.on('click', '.md-card-fullscreen-deactivate', function() {
          ...
          r.velocity(
            { height: i, width: a },
            {
              ...
              begin: function(e) {
                r
                  ...
                  .velocity('transition.slideDownOut', { duration: 275, easing: easing_swiftOut }),
            ...
            { left: s, top: n },
            {
              ...
              easing: easing_swiftOut,
              complete: function(i) {
                r.removeClass('md-card-fullscreen').css({ width: '', height: '', left: '', top: '' }),
                  e.remove(),
    ...
    card_expand: function() {
      $('.md-expand').velocity('transition.expandIn', { stagger: 175, drag: !0 }),
        $('.md-expand-group')
          .children()
    ...
    card_progress: function(e, i, a) {
      (e ? $(e).children('.md-card-toolbar') : $('[data-toolbar-progress]')).each(function() {
        ...
        e.css({ background: '-moz-linear-gradient(left, ' + s + ' ' + t + '%, #fff ' + t + '%)' })
          .css({ background: 'linear-gradient(to right,  ' + s + ' ' + t + '%, #fff ' + t + '%)' })
          .css({ background: '-webkit-linear-gradient(left, ' + s + ' ' + t + '%, #fff ' + t + '%)' });
      });
    },
    list_outside: function() {
      var e = $('.md-list-outside-wrapper'),
        i = e.children('.md-list-outside-inner');
      if (e && $body.hasClass('header_double_height')) {
        function a() {
      ...
      $(e).each(function() {
        ...
        e.closest('.uk-input-group').removeClass('uk-input-group-danger uk-input-group-success'),
          ...
          e.hasClass('md-input-danger') &&
            (e.closest('.uk-input-group').length && e.closest('.uk-input-group').addClass('uk-input-group-danger'),
            e.closest('.md-input-wrapper').addClass('md-input-wrapper-danger')),
          e.hasClass('md-input-success') &&
            (e.closest('.uk-input-group').length && e.closest('.uk-input-group').addClass('uk-input-group-success'),
        ...
        e.closest('.md-fab-wrapper').addClass('md-fab-active'),
          e.velocity(
            { scale: 0 },
            {
              ...
              easing: easing_swiftOut,
              complete: function() {
                e.velocity({ scale: 1 }, { duration: 140, easing: easing_swiftOut })
                  .children()
                  .toggle();
              }
            }
      ...
      e.children('.scrollbar-inner').length || e.wrapInner("<div class='scrollbar-inner'></div>"),
        Modernizr.touch
          ...
          : e
              ...
              .scrollbar({ scrollx: !1, duration: 100, ignoreMobile: !0, ignoreOverlay: !0 });
    },
    hierarchical_show: function(e) {
      ...
      if (
                ...
                i.waypoint({
                  handler: function() {
                    i.addClass('hierarchical_show_inView'),
                      setTimeout(function() {
                        i.removeClass('hierarchical_show hierarchical_show_inView fast_animation')
                          .children()
                          .css({ '-webkit-animation-delay': '', 'animation-delay': '' });
                      }, 100 * a + 1200),
                      this.destroy();
                  },
                  context: 'window',
        ...
        a.children().each(function(e) {
          ...
          a.addClass(''),
          setTimeout(function() {
            a.removeClass('hierarchical_show hierarchical_show_inView fast_animation')
              .children()
              .css({ '-webkit-animation-delay': '', 'animation-delay': '' });
          }, 100 * t + 1200);
      }
      ...
      if (
                  ...
                  e.addClass('hierarchical_slide_inView'),
                    setTimeout(function() {
                      e.removeClass('hierarchical_slide hierarchical_slide_inView'),
                        i.css({ '-webkit-animation-delay': '', 'animation-delay': '' });
                    }, 100 * a + 1200),
                    this.destroy();
                },
                context: t,
        ...
        console.log(t),
          n >= 1 &&
            ...
            setTimeout(function() {
              a.removeClass('hierarchical_slide hierarchical_slide_inView'),
                t.css({ '-webkit-animation-delay': '', 'animation-delay': '' });
            }, 100 * n + 1200));
      }
    },
      ...
      if (!$body.find('.content-preloader').length) {
        var s = isHighDensity() ? '@2x' : '',
          ...
          'regular' == e
            ...
            : '<div class="md-preloader"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="' +
              n +
              '" width="' +
              t +
              '" viewbox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"/></svg></div>');
        (void 0 !== a ? $(a) : $body).append(
    ...
    color_picker: function(e, i, a) {
      if (e) {
        for (
          ...
          var d =
            'md-bg-' == n[o].substring(0, 6)
              ? '<span data-color=' + n[o] + ' class="' + n[o] + '"></span>'
              : '<span data-color=' + n[o] + ' style="background:' + n[o] + '"></span>';
          r.append(d);
        }
        return (
      ...
      e.length &&
        e.on('click', function(i) {
          i.preventDefault(),
            screenfull.enabled &&
              (screenfull.request(),
              e.children('.material-icons').text('fullscreen_exit'),
              screenfull.isFullscreen && (screenfull.exit(), e.children('.material-icons').text('fullscreen'))),
            $window.resize();
        });
    },
    ...
    accordion_user_selected: function() {
      $('[data-accordion-section-open]').each(function() {
        ...
        setTimeout(function() {
          var i = e.data();
          if (
            ((sectOpen = i.accordionSectionOpen.toString().split(',')),
            e.children('.uk-accordion-title.uk-active').each(function() {
              $(this).trigger('click');
            }),
            !i.accordion.options.collapse && sectOpen.length > 1)
          )
            for (var a = 0; a <= sectOpen.length; a++)
              e.children('.uk-accordion-title')
                .eq(sectOpen[a] - 1)
                .trigger('click');
          else
            e.children('.uk-accordion-title')
