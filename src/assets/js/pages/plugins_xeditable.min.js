  ...
  (altair_xeditable = {
    x_ajax: function() {
      function a(a, e) {
        ...
        i.push('RESPONSE: status = ' + e.status),
          e.responseText &&
    ...
    x_options: function() {
      ($.fn.editable.defaults.url = '/post'),
        ...
        ($.fn.editableform.buttons =
          '<div class="editable-footer"><button type="button" class="editable-cancel md-btn md-btn-small md-btn-flat">cancel</button><button type="submit" class="editable-submit md-btn md-btn-small md-btn-flat md-btn-flat-primary">ok</button></div>');
    },
    x_address: function() {
      !(function(a) {
        'use strict';
        ...
        a.fn.editableutils.inherit(e, a.fn.editabletypes.abstractinput),
          a.extend(e.prototype, {
            ...
            value2input: function(a) {
              a &&
                (this.$input.filter('[name="city"]').val(a.city),
                this.$input.filter('[name="street"]').val(a.street),
                this.$input.filter('[name="building"]').val(a.building));
            },
    ...
    x_plugins: function() {
        ...
        $('#sex').editable({
          ...
          display: function(a, e) {
            ...
            t.length
              ? $(this)
                  .text(t[0].text)
                  .css('color', { '': 'gray', 1: 'green', 2: 'blue' }[a])
              : $(this).empty();
          }
        }),
        $('#status').editable(),
      ...
      $.each(
        ...
        $('#country').editable({ source: a, select2: { width: 200, placeholder: 'Select country', allowClear: !0 } }),
