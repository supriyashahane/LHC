$(function() {
  ...
  (kendoUI = {
      ...
      n.length &&
        n
          .kendoAutoComplete({
            ...
            template:
              '<div class="k-list-wrapper"><span class="k-state-default k-list-wrapper-addon"><img src="assets/img/avatars/avatar_#:data.CustomerID#_tn.png" alt="#:data.CustomerID#" /></span><span class="k-state-default k-list-wrapper-content"><p>#: data.ContactName #</p><span class="uk-text-muted uk-text-small">#: data.CompanyName #</span></span></div>',
            ...
            .kendoDateTimePicker({
              ...
              change: function() {
                var e = o.value(),
                  t = i.value();
                e
                  ? ((e = new Date(e)).setDate(e.getDate()), i.min(e))
                  : t
                    ? o.max(new Date(t))
                    : ((t = new Date()), o.max(t), i.min(t));
              },
            ...
            .kendoDateTimePicker({
              ...
              change: function() {
                var e = i.value(),
                  t = o.value();
                e
                  ? ((e = new Date(e)).setDate(e.getDate()), o.max(e))
                  : t
                    ? i.min(new Date(t))
                    : ((e = new Date()), o.max(e), i.min(e));
              },
              parseFormats: ['MM/dd/yyyy']
            })
            .data('kendoDateTimePicker');
        ...
        t
          .kendoMultiSelect({
            ...
            itemTemplate:
              '<div class="k-list-wrapper"><span class="k-state-default k-list-wrapper-addon"><img src="assets/img/avatars/avatar_#:data.CustomerID#_tn.png" alt="#:data.CustomerID#" /></span><span class="k-state-default k-list-wrapper-content"><p>#: data.ContactName #</p><span class="uk-text-muted uk-text-small">#: data.CompanyName #</span></span></div>',
            tagTemplate:
              '<img class="k-tag-image" src="assets/img/avatars/avatar_#:data.CustomerID#_tn.png" alt="${data.CustomerID}" />#: data.ContactName #',
            dataSource: { transport: { read: { dataType: 'json', url: 'data/kUI_users_data.min.json' } } },
    ...
    numeric_textbox_widget: function() {
      ...
      t.length && t.kendoNumericTextBox({ format: 'p0', min: 0, max: 0.1, step: 0.01 });
