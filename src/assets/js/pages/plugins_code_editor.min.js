    ...
    (cEditor = CodeMirror.fromTextArea(document.getElementById('codeEditor'), {
      ...
      $(file_list_class)
        ...
        .on('click', function(t) {
          t.preventDefault();
          var e = $(this),
            i = e.attr('data-editor-file'),
            o = e.attr('data-editor-mode');
          if (!e.closest('li').hasClass('md-list-item-active')) {
            var r, c, d;
            (r = 'data/codemirror/file_content.php?file=' + i),
              (c = o),
              (d = function() {
                e.closest('li')
                ...
                { opacity: 0 },
                {
                  ...
                  complete: function() {
                    $.ajax({
                      ...
                      success: function(t) {
                        'html' == c &&
                          (cEditor.setOption('mode', 'text/html'), cEditor.setOption('matchTags', { bothTags: !0 })),
                          'js' == c &&
                            (cEditor.setOption('mode', 'text/javascript'), cEditor.setOption('matchBrackets', !0)),
                          'php' == c &&
                            (cEditor.setOption('mode', 'application/x-httpd-php'),
                            cEditor.setOption('matchTags', !1),
                            cEditor.setOption('matchBrackets', !0)),
                          'json' == c && cEditor.setOption('mode', 'application/json'),
                          cEditor.setValue(t),
                          'function' == typeof d && d(),
                          setTimeout(function() {
  ...
  change_theme: function() {
    $('#code_editor_theme')
      ...
      .click(function(t) {
        t.preventDefault();
        var e,
          i = $(this).attr('data-editor-theme');
        (e = i),
          cEditor.setOption('theme', e),
          $(this)
            .closest('li')
            .addClass('uk-active')
            .siblings('li')
