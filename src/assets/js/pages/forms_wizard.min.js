$(function() {
  ...
  (altair_wizard = {
    content_height: function(t, i) {
      ...
      $(t)
        .children('.content')
        .animate({ height: e }, 140, bez_easing_swiftOut);
    },
        ...
        (t.steps({
          ...
          onInit: function(i, e) {
            altair_wizard.content_height(t, e),
              ...
              $('.wizard-icheck').on('ifChecked', function(t) {
                console.log(t.currentTarget.value);
              }),
              altair_uikit.reinitialize_grid_margin(),
              altair_forms.select_elements(t),
              t.find('span.switchery').remove(),
              altair_forms.switches(),
              altair_forms.dynamic_fields(t, !0, !0),
          ...
          onStepChanging: function(i, e, a) {
            var n = t.find('.body.current').attr('data-step'),
              r = $('.body[data-step="' + n + '"]');
            return (
              r.find('.parsley-row').each(function() {
                $(this)
