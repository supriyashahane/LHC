    ...
    init: function() {
      $('#students_crud')
        .jtable({
          ...
          formCreated: function(t, e) {
            e.form.find('.jtable-option-text-clickable').each(function() {
              ...
              e.form.find('input[type="checkbox"],input[type="radio"]').each(function() {
                var t = $(this);
                t.iCheck({ checkboxClass: 'icheckbox_md', radioClass: 'iradio_md', increaseArea: '20%' })
          ...
          fields: {
            StudentId: { key: !0, create: !1, edit: !1, list: !1 },
            Name: { title: 'Name', width: '23%' },
            EmailAddress: { title: 'Email address', list: !1 },
            Password: { title: 'User Password', type: 'password', list: !1 },
            Gender: { title: 'Gender', width: '13%', options: { M: 'Male', F: 'Female' } },
            CityId: { title: 'City', width: '12%', options: 'data/crud_table/cities.php' },
            BirthDate: {
              title: 'Birth Date',
              width: '15%',
              ...
              input: function(t) {
                return t.record
                  ? '<input class="md-input" type="text" name="BirthDate" value="' +
                      t.value +
                      '" data-uk-datepicker="{format:\'DD/MM/YYYY\'}"/>'
                  : '<input class="md-input" type="text" name="BirthDate"  value="" data-uk-datepicker="{format:\'DD/MM/YYYY\'}"/>';
              }
            },
            Education: {
              title: 'Education',
            ...
            About: { title: 'About this person', type: 'textarea', list: !1 },
            IsActive: {
              title: 'Status',
              width: '12%',
              type: 'checkbox',
