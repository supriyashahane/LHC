...
altair_mailbox_v2 = {
    ...
    $mailbox.on('ifChanged', '[data-md-icheck]', function() {
      ...
      $('#mailboxV2_select_all').on('ifChanged', function() {
        ...
        $mailbox.find('[data-md-icheck]').each(function() {
          e.is(':checked') ? $(this).iCheck('check') : $(this).iCheck('uncheck');
        });
      });
  },
  ...
  create_message: function() {
    ...
    var e = $('#mail_progressbar'),
      a = e.find('.uk-progress-bar'),
      i = {
        action: './upload/',
        single: !1,
        loadstart: function() {
          a.css('width', '0%').text('0%'), e.removeClass('uk-hidden uk-progress-danger');
        },
        progress: function(e) {
          (e = Math.ceil(e)), a.css('width', e + '%').text(e + '%'), '100' == e && setTimeout(function() {}, 1500);
        },
        error: function(i) {
          e.addClass('uk-progress-danger'), a.css({ width: '100%' }).text('100%');
        },
        abort: function(e) {
          console.log(e);
        },
