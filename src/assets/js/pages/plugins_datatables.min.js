$(function() {
  ...
  (altair_datatables = {
    ...
    dt_colVis: function() {
      ...
      t.length &&
        t
          .DataTable({ buttons: [{ extend: 'colvis', fade: 0 }] })
          .buttons()
          .container()
          .appendTo(a);
    },
    dt_tableExport: function() {
      ...
      t.length &&
        t
          .DataTable({
            buttons: [
              { extend: 'copyHtml5', text: '<i class="uk-icon-files-o"></i> Copy', titleAttr: 'Copy' },
              { extend: 'print', text: '<i class="uk-icon-print"></i> Print', titleAttr: 'Print' },
