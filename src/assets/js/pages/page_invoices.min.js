...
altair_invoices = {
          ...
          var o = function() {
            var i = $('#invoice_form_template_services'),
              ...
              t = Handlebars.compile(n)({
                invoice_service_id: e.children().length
                  ? parseInt(e.children('.uk-grid:last').attr('data-service-number')) + 1
                  : 1
              });
            e.append(t), altair_md.inputs(), altair_forms.textarea_autosize(), altair_uikit.reinitialize_grid_margin();
          };
          o(),
            $('#invoice_form_append_service_btn').on('click', function(i) {
              i.preventDefault(), o();
            }),
            altair_md.checkbox_radio();
        },
        e = function() {
          $invoice_card.css({ height: '' }),
            $invoice_form.show(),
  ...
  open_invoice: function() {
          ...
          invoice: {
            ...
            invoice_services: [
              ...
              },
              {
                ...
                service_description:
                  'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab blanditiis cupiditate delectus deserunt.',
                service_rate: '$50.00',
                service_hours: '20',
                service_vat: '23%',
    ...
    $(invoice_list_class).on('click', 'a', function(e) {
      ...
      $(invoice_list_class).find('a').length
        ? $(invoice_list_class)
            .find('a')
            .eq(0)
            .click()
  ...
  copy_list_sidebar: function() {
    ...
    i.attr('id', 'invoices_list_sidebar'),
      $sidebar_secondary
        .find('.sidebar_secondary_wrapper')
        .html(i)
        .end();
  },
  search_invoices: function() {
    $('#invoice-filtering').instaFilta({ targets: '#invoices_list > li:not(.heading_list)' });
  }
};
