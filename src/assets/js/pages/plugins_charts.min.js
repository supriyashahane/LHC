$(function() {
  ...
  (altair_charts = {
    metrics_graphics: function() {
      ...
      if ($(e).length && $(t).length) {
        function i() {
          ...
          d3.json('data/mg_brief-1.min.json').then(function(t) {
            (t = MG.convert.date(t, 'date')),
              MG.data_graphic({ data: t, linked: !0, width: i, height: n, xax_count: 4, target: e });
          }),
            d3.json('data/mg_brief-2.min.json').then(function(e) {
              (e = MG.convert.date(e, 'date')),
                MG.data_graphic({ data: e, area: !1, linked: !0, width: o, height: a, xax_count: 4, target: t });
            });
        }
        i(),
      ...
      var o = '#mg_chart_confidence_band',
        r = $(o).height();
      if ($(o).length) {
        function s() {
          var e = $(o).width();
    ...
    chartist_charts: function() {
      ...
      var a = new Chartist.Bar(
        '#chartist_distributed_series',
      ...
      var d = new Chartist.Pie(
        '#chartist_donut_animate',
