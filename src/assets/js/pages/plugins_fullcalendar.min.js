    ...
    calendar_selectable: function() {
      ...
      t.length &&
        t.fullCalendar({
          ...
          select: function(a, r) {
            UIkit.modal.prompt(
              '<h3 class="heading_b uk-margin-medium-bottom">New Event</h3><div class="uk-margin-medium-bottom" id="calendar_colors">Event Color:' +
                e +
                '</div>Event Title:',
              '',
              function(e) {
                if ('' !== $.trim(e)) {
                  var o,
                    d = $('#calendar_colors_wrapper')
                      .find('input')
                      .val();
                  (o = { title: e, start: a, end: r, color: d || '' }),
