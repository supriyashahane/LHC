$(function() {
  ...
  var o = UIkit.modal('#modal_idle', { bgclose: !1 }),
    n = {
      ...
      warningStart: null,
      warningTimer: null,
      autologout: { logouturl: 'login.html' },
      logout: function() {
  ...
  $(document).on('idle.idleTimer', function(i, e, a) {
    var l = +new Date() - a.lastActive - a.timeout,
      u = +new Date() - l;
    l >= n.warningTimeout || u <= n.minWarning
      ? o.hide()
      : (t.html(Math.round((n.warningTimeout - l) / 1e3)),
        o.show(),
        (n.warningStart = +new Date() - l),
        (n.warningTimer = setInterval(function() {
