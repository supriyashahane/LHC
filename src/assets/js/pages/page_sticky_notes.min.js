$(function() {
  altair_sticky_notes.add_note(),
    ...
    $('#top_bar')
      .find('.uk-slidenav-position')
      .on('focusitem.uk.slider', function(e, t, a) {
...
var $note_template = $('#note_template').html(),
  ...
  changeBg = function(e) {
    var t = $('#notes_colors_wrapper')
      .find('input')
      .val();
    void 0 !== t &&
      ($.each(pallete, function(e, t) {
        var a = replaceColor(t);
        $card.hasClass(a) && $card.removeClass(a);
      }),
      e || $card.addClass(replaceColor(t)));
  },
  notesColorPicker = altair_helpers
    .color_picker($('<div id="notes_colors_wrapper"></div>'), pallete, changeBg)
    .prop('outerHTML');
...
altair_sticky_notes = {
  add_note: function() {
    $form_card.css({ minHeight: $form_card.actual('height') }),
      $form_card.on('click', function(e) {
        if (!$form_card.hasClass('card-expanded')) {
          var t = Handlebars.compile($note_form_template);
          (html = t({
            labels: [
              { text: 'label 1', text_safe: 'label_1', type: 'default' },
              { text: 'label 2', text_safe: 'label_2', type: 'warning' },
              { text: 'label 3', text_safe: 'label_3', type: 'danger' },
              { text: 'label 4', val: 'label_4', type: 'success' },
              { text: 'label 5', text_safe: 'label_5', type: 'primary' }
            ]
          })),
            $form.hide().html(html),
            $note_form_text.hide();
      ...
      $form.on('click', '#note_add', function(e) {
        ...
        var t = $('#note_f_title'),
          ...
          i = $('#note_f_content'),
          r = i.val().replace(/\n/g, '<br />');
        if ((t.removeClass('md-input-danger'), i.removeClass('md-input-danger'), '' == a))
          return t.addClass('md-input-danger'), void altair_md.update_input(t);
        if ('' == r) return i.addClass('md-input-danger'), void altair_md.update_input(i);
        if (a && r) {
          var o = $('#notes_cp')
              .find('input')
              .val(),
            l = [{ time: new Date().getTime(), color: replaceColor(o), title: a, content: r }],
          ...
          if (n) {
            ...
            $.each(n, function(e, t) {
              var a = $(t);
              c.push({ id: a.attr('id'), checked: a.is(':checked'), title: a.attr('data-title') });
            }),
              (l[0].checklist = c);
          }
          if (d) {
    ...
    var e = function() {
      var e = $('#note_form_checkbox_template').html(),
        ...
        a = $('#checklist_item'),
        i = a.val(),
        r = t({ id: randID_generator(), title: i });
      if ('' != i) {
  ...
  actions: function() {
    $grid.on('click', '.note_action_remove', function() {
      var e = $(this)
        .closest('.md-card')
        .parent();
      e.addClass('uk-animation-scale-up uk-animation-reverse'),
        setTimeout(function() {
          e.remove();
        }, 300);
    });
    ...
    var e = Handlebars.compile($note_template)([
      {
        ...
        content:
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam molestias quidem repellendus saepe vero! Assumenda fugiat perferendis reiciendis repellat voluptas?',
        labels: [{ type: 'primary', text: 'label 5', text_safe: 'label-5' }]
      },
      {
        time: 1475691265322,
        title: 'Lorem ipsum',
        content:
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam molestias quidem repellendus saepe vero!',
        labels: [{ type: 'default', text: 'label 1', text_safe: 'label-1' }],
        checklist: [
          { checked: !1, title: 'first item' },
          { checked: !0, title: 'second item' },
          { checked: !1, title: 'third item' },
          { checked: !1, title: 'fourth item' }
        ]
      },
      {
        time: 1475691265322,
        ...
        content:
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda fugiat perferendis reiciendis repellat voluptas?',
        labels: [
          { type: 'warning', text: 'label 2', text_safe: 'label-2' },
          { type: 'danger', text: 'label 3', text_safe: 'label-3' }
        ]
      },
      {
        time: 14756046e5,
        ...
        content:
          'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam molestias quidem repellendus saepe vero! Assumenda fugiat perferendis reiciendis repellat voluptas?',
        labels: [
          { type: 'success', text: 'label 4', text_safe: 'label-4' },
          { type: 'primary', text: 'label 5', text_safe: 'label-5' }
        ]
      }
    ]);
