          ...
          highlight: function(b) {
            ...
            return 0 === arguments.length
              ...
              : (b >= c.length && (b = c.length - 1),
                ...
                void (e && this.opts.element.trigger({ type: 'select2-highlight', val: this.id(e), choice: e })));
          },
          ...
          updateResults: function(c) {
            ...
            if (
              ...
              if (
                ...
                return void n(
                  "<li class='select2-selection-limit'>" + K(f.formatSelectionTooBig, f.element, o) + '</li>'
                );
            ...
            this.opts.minimumResultsForSearch >= 0 && this.showSearch(!0),
              ...
              this.opts.shouldFocusInput(this) &&
                ...
                b.createTextRange
                  ...
                  : b.setSelectionRange && ((d = this.search.val().length), b.setSelectionRange(d, d))),
          ...
          initSelection: function() {
            if (this.isPlaceholderOptionSelected()) this.updateSelection(null), this.close(), this.setPlaceholder();
              ...
              this.opts.initSelection.call(null, this.opts.element, function(a) {
                a !== b &&
                  null !== a &&
                  (c.updateSelection(a), c.close(), c.setPlaceholder(), (c.lastSearchTerm = c.search.val()));
              });
            }
          },
          ...
          val: function(c, d) {
            ...
            if (((e = this.data()), e.length || (e = []), !c && 0 !== c))
              return (
                ...
                this.clearSearch(),
                void (d && this.triggerChange({ added: this.data(), removed: e }))
              );
