    ...
    return (
      this.each(function() {
        var e,
          ...
          c = '';
        a.scope
          ? ((o = t(this).closest(a.scope)), (n = o.find(a.targets)), (r = o.find(a.sections)))
          : ((n = t(a.targets)), (r = t(a.sections))),
          n.each(function() {
            ($target = t(this)),
        ...
        var l = function() {
            r.each(function() {
              var e = t(this);
              e.find('[data-instafilta-hide="false"]').length
                ? e[a.sectionsShowEffect](a.sectionsShowDuration)
                : e[a.sectionsHideEffect](a.sectionsHideDuration);
            });
          },
          f = function(t) {
            var e = (function() {
              ...
              .filter('[data-instafilta-hide="false"]')
              [a.itemsShowEffect](a.itemsShowDuration);
            return (
              t || n.filter('[data-instafilta-hide="true"]')[a.itemsHideEffect](a.itemsHideDuration),
              a.hideEmptySections && l(),
              'function' == typeof a.onFilterComplete && a.onFilterComplete.apply(this, [e]),
              e
            );
          },
          u = function() {
            ...
            c === e
              ...
              : ((c = e),
                ...
                n.each(function() {
                  var i = t(this);
                  i.data('originalText') ||
                    (i.data('originalHtml', i.html()), i.data('originalText', i.data('values')[0]));
                  var s = (function(t, e) {
                      for (
                        var i = -1, s = 0;
                        s < t.length && ((i = (a.caseSensitive ? t[s] : t[s].toLowerCase()).indexOf(e)), !(i >= 0));
                        s++
                      );
                      return i;
                    })(i.data('values'), e),
                  ...
                  s >= 0 &&
                    a.markMatches &&
                    ((r = n.substring(s, s + e.length)),
                    (o = n.replace(r, '<span class="' + a.matchCssClass + '">' + r + '</span>')),
                    i.html(i.data('originalHtml').replace(n, o))),
                    i.attr('data-instafilta-hide', (a.beginsWith && 0 !== s) || 0 > s ? 'true' : 'false');
                }),
                f())
          );
        }),
